                    ...
                    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                        <div class="menu_section">
                            ...
                            <ul class="nav side-menu">
                                <li><a><i class="fa fa-home"></i> Site Ayarları <span
                                ...
                                <li><a><i class="fa fa-home"></i> Anasayfa Ayarları <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                ...
                                <li><a><i class="fa fa-envelope"></i> Mesajlar <span
                                            class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="iletisimform.php">İletişim Formu</a></li>
                                        <li><a href="franchisingform.php">Franchising Formu</a></li>
                                    </ul>
                                </li>
                                <li><a><i class="fa fa-info"></i>Hakkımızda <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        <li><a href="about.php">Bizi Tanıyın</a></li>
                                    </ul>
                                </li>
                                <li><a href="urunler.php"><i class="fa fa-table"></i> Ürünlerimiz</a>
                                </li>
